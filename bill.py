...
class Bill_App:
    def __init__(self, root):
        ...
        face_cream_tax=Entry(F2, width=10, textvariable=self.face_cream, font=("times new roman", 16, "bold"),bd=5, relief=SUNKEN).grid(row=1, column=1, padx=10, pady=10)
        ...
        body_lbl_tax=Entry(F2, width=10, textvariable=self.loshan, font=("times new roman", 16, "bold"),bd=5, relief=SUNKEN).grid(row=5, column=1, padx=10, pady=10)
        ...
        c4_xt=Entry(F4,width=10,textvariable=self.thumbsup,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=3,column=1,padx=10,pady=10)
        ...
        c6_lbl=Label(F4,text="Sting",font=("times new roman",16,"bold"),bg=bg_color,fg="lightgreen").grid(row=5,column=0,padx=10,pady=10,sticky="w")
        c6_txt=Entry(F4,width=10,textvariable=self.sting,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=5,column=1,padx=10,pady=10)
        ...
        total_btn=Button(btn_F, text="Total", bg="cadetblue", bd=2, fg="white", pady=15,width=10, font="arial 15 bold", command=self.total).grid(row=0, column=0, padx=5, pady=5)
        GBill_btn=Button(btn_F, text="Generate Bill",command=self.bill_area, bg="cadetblue", bd=2, fg="white", pady=15,width=10, font="arial 15 bold").grid(row=0, column=1, padx=5, pady=5)
        Clear_btn=Button(btn_F, text="Clear", bg="cadetblue", bd=2, fg="white", pady=15,width=10, font="arial 15 bold").grid(row=0, column=2, padx=5, pady=5)
        Exit_btn=Button(btn_F, text="Exit", bg="cadetblue", bd=2, fg="white", pady=15,width=10, font="arial 15 bold", command=self.root.destroy).grid(row=0, column=3, padx=5, pady=5)
        self.welcome_bill()
    ...
    def total(self):
        ...
        c_tax = round(self.total_cosmetic_price * 0.05, 2)
        self.cosmetic_tax.set("Rs. " + str(c_tax))
        self.c_tax = c_tax
        ...
        g_tax = round(self.total_grocery_price * 0.01, 2)
        self.grocery_tax.set("Rs. " + str(g_tax))
        self.g_tax = g_tax
        ...
        cd_tax = round(self.total_cold_drink_price * 0.05, 2)
        self.cold_drink_tax.set("Rs. " + str(cd_tax))
        self.d_tax = cd_tax
    ...
    def welcome_bill(self):
        ...
        self.textarea.insert(END,"\tWelcome Webcode Reatill\n")
    ...
    def bill_area(self):
        ...
        if self.sting.get()!=0:
            self.textarea.insert(END,f"\n Sting\t\t{self.sting.get()}\t\t{self.d_s_p}")
        ...
        messagebox.showinfo("Total", "Total Bill Calculated Successfully!")
